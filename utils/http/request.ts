...
type _RequestInit<T = void, RawT = any> = RequestInit & {
  disableBaseUrl?: boolean;
  transform?: (data: RawT) => T;
};
...
const myFetch = async <T = void, RawT = any>(
  url: string,
  options?: _RequestInit<T, RawT>
) => {
...
export const get = <T = void, RawT = any>(
  url: string,
  params?: SearchParams,
  options?: _RequestInit<T, RawT>
) =>
...
export const post = <T = void, RawT = any>(
  url: string,
...
export const put = <T = void, RawT = any>(
  url: string,
  params?: Record<string, any>,
  options?: _RequestInit<T, RawT>
) =>
...
export const del = <T = void, RawT = any>(
  url: string,
  params?: Record<string, any>,
  options?: _RequestInit<T, RawT>
) =>
